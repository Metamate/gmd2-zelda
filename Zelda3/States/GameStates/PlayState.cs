...
using Zelda3.Definitions;
using Zelda3.Entities;
using Zelda3.States.PlayerStates;
using Zelda3.World;

namespace Zelda3.States.GameStates;
...
public class PlayState(Game1 game) : GameStateBase(game)
{
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        // Every frame, PlayState asks: is the player dead yet?
        // In the next step, the room tells PlayState instead, with an event.
        if (_player.Health <= 0)
